...
def process_inputs(audio_filepath, image_filepath):
    try:
        if not audio_filepath:
            return "No audio provided.", "Please record a question or description before submitting.", None
        ...
        voice_filepath = text_to_speech_with_elevenlabs(
            input_text=doctor_response,
            output_filepath_mp3="doctor_response.mp3"
        )
